...
include (${MOAB_DIR}/ResolveCompilerPaths.cmake)
...
set (MOAB_PACKAGE_INCLUDES2 "@ZOLTAN_INCLUDES@ @PNETCDF_INCLUDES@ @NETCDF_INCLUDES@ @HDF5_INCLUDES@ @PARMETIS_INCLUDES@ @METIS_INCLUDES@ -I@EIGEN3_INCLUDE_DIR@ @IGEOM_INCLUDES@ @CGM_INCLUDES@" )
string(STRIP "${MOAB_PACKAGE_INCLUDES2}" MOAB_PACKAGE_INCLUDES2)

RESOLVE_INCLUDES(MOAB_PACKAGE_INCLUDES "${MOAB_PACKAGE_INCLUDES2}")
