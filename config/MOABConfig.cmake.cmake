...
set(MOAB_CXX @MPI_C_COMPILER@)
set(MOAB_CC @MPI_CXX_COMPILER@)
set(MOAB_FC @MPI_Fortran_COMPILER@)
set(MOAB_F77 @MPI_Fortran_COMPILER@)

set(MOAB_BUILT_SHARED @BUILD_SHARED_LIBS@)
set(MOAB_USE_MPI @MOAB_HAVE_MPI@)
set(MPI_DIR "@MPI_HOME@")
set(MOAB_USE_HDF @MOAB_HAVE_HDF5@)
...
set(MOAB_USE_EIGEN @MOAB_HAVE_EIGEN@)
...
set(MOAB_LIBRARIES "-L@CMAKE_INSTALL_PREFIX@/@CMAKE_INSTALL_LIBDIR@ -lMOAB @LIBS@")
set(DAGMC_LIBRARIES "-L@CMAKE_INSTALL_PREFIX@/@CMAKE_INSTALL_LIBDIR@ -ldagmc -lMOAB")
