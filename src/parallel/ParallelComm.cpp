...
#define ppstat(a, b) { if (pstat & a) { if (num) str << ", "; str << b; num++; } }
  ...
  //
  void ParallelComm::trivial_partition (int sender_rank, std::vector<int> & recvRanks,
  ...
  // their data
  void ParallelComm::senders_trivial_partition(std::vector<int> & sndrRanks, std::vector<int> & number_elems_per_part,
