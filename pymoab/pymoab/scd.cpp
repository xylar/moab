/* Generated by Cython 0.20.1 on Fri Apr 28 14:31:26 2017 */
...
static PyObject *__pyx_pf_6pymoab_3scd_6ScdBox_14get_params(struct __pyx_obj_6pymoab_3scd_ScdBox *__pyx_v_self, moab::EntityHandle __pyx_v_entity, PyObject *__pyx_v_exceptions); /* proto */
static PyObject *__pyx_pf_6pymoab_3scd_6ScdBox_16contains(struct __pyx_obj_6pymoab_3scd_ScdBox *__pyx_v_self, int __pyx_v_i, int __pyx_v_j, int __pyx_v_k); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_6pymoab_3scd_6ScdBox_15get_params(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6pymoab_3scd_6ScdBox_14get_params[] = "\n        Returns the parametric coordinates of the specified entity.\n\n        Examples\n        --------\n\n        ijk = scdbox.get_params(vertex_handle)\n\n        OR\n\n        ijk = scdbox.get_params(hex_handle)\n\n        Parameters\n        ----------\n        entity : MOAB EntityHandle\n           entity handle for which parameter values are returned\n        exceptions : tuple (default is empty tuple)\n            A tuple containing any error types that should\n            be ignored. (see pymoab.types module for more info)\n        Returns\n        -------\n        A list of ints containing the parameter values for the specified entity.\n\n        Raises\n        ------\n        ValueError\n            if the entity parameter is not of the right type\n        MOAB ErrorCode\n            if a MOAB error occurs\n        ";
static PyObject *__pyx_pw_6pymoab_3scd_6ScdBox_15get_params(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("get_params (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_params") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 239; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  2: values[1] = PyTuple_GET_ITEM(__pyx_args, 1);
    ...
    __pyx_v_entity = __Pyx_PyInt_As_moab_3a__3a_EntityHandle(values[0]); if (unlikely((__pyx_v_entity == (moab::EntityHandle)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 239; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_exceptions = values[1];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_params", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 239; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("pymoab.scd.ScdBox.get_params", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6pymoab_3scd_6ScdBox_14get_params(((struct __pyx_obj_6pymoab_3scd_ScdBox *)__pyx_v_self), __pyx_v_entity, __pyx_v_exceptions);
...
static PyObject *__pyx_pf_6pymoab_3scd_6ScdBox_14get_params(struct __pyx_obj_6pymoab_3scd_ScdBox *__pyx_v_self, moab::EntityHandle __pyx_v_entity, PyObject *__pyx_v_exceptions) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  enum moab::ErrorCode __pyx_v_err;
 ...
 * 
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_check_error); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 272; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyInt_FromLong(__pyx_v_err); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 272; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_j); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 273; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_k); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 273; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = PyList_New(3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 273; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
...
/* Python wrapper */
static PyObject *__pyx_pw_6pymoab_3scd_6ScdBox_17contains(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6pymoab_3scd_6ScdBox_16contains[] = "\n        Returns True if the specified parameter values are within the ScdBox;\n        False if not.\n        ";
static PyObject *__pyx_pw_6pymoab_3scd_6ScdBox_17contains(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("contains (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_j)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("contains", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 275; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_k)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("contains", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 275; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "contains") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 275; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_i = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_i == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 275; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_j = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_j == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 275; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_k = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_k == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 275; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("contains", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 275; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("pymoab.scd.ScdBox.contains", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6pymoab_3scd_6ScdBox_16contains(((struct __pyx_obj_6pymoab_3scd_ScdBox *)__pyx_v_self), __pyx_v_i, __pyx_v_j, __pyx_v_k);
...
static PyObject *__pyx_pf_6pymoab_3scd_6ScdBox_16contains(struct __pyx_obj_6pymoab_3scd_ScdBox *__pyx_v_self, int __pyx_v_i, int __pyx_v_j, int __pyx_v_k) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyBool_FromLong(__pyx_v_self->inst->contains(__pyx_v_i, __pyx_v_j, __pyx_v_k)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 280; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods_6pymoab_3scd_ScdBox[] = {
  ...
  {__Pyx_NAMESTR("get_params"), (PyCFunction)__pyx_pw_6pymoab_3scd_6ScdBox_15get_params, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_6pymoab_3scd_6ScdBox_14get_params)},
  {__Pyx_NAMESTR("contains"), (PyCFunction)__pyx_pw_6pymoab_3scd_6ScdBox_17contains, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_6pymoab_3scd_6ScdBox_16contains)},
  {0, 0, 0, 0}
};
