...
MATERIAL_SET_TAG_NAME   = str(tag_conventions.MATERIAL_SET_TAG_NAME)
DIRICHLET_SET_TAG_NAME  = str(tag_conventions.DIRICHLET_SET_TAG_NAME)
NEUMANN_SET_TAG_NAME    = str(tag_conventions.NEUMANN_SET_TAG_NAME)
HAS_MID_NODES_TAG_NAME  = str(tag_conventions.HAS_MID_NODES_TAG_NAME)
GEOM_DIMENSION_TAG_NAME = str(tag_conventions.GEOM_DIMENSION_TAG_NAME)
MESH_TRANSFORM_TAG_NAME = str(tag_conventions.MESH_TRANSFORM_TAG_NAME)
GLOBAL_ID_TAG_NAME      = str(tag_conventions.GLOBAL_ID_TAG_NAME)
CATEGORY_TAG_NAME       = str(tag_conventions.CATEGORY_TAG_NAME)
CATEGORY_TAG_SIZE       = tag_conventions.CATEGORY_TAG_SIZE
NAME_TAG_NAME           = str(tag_conventions.NAME_TAG_NAME)
