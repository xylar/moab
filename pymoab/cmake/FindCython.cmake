...
SET(CYTHON_FLAGS --cplus --fast-fail -I /home/shriwise/dagmc_blds/moabs/src/src/)
# copy test file into build dir
FILE(COPY "${CMAKE_CURRENT_SOURCE_DIR}/cmake/cython_test.pyx" DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/cmake/")
SET(Cython_FOUND FALSE)
IF (CYTHON_BIN)
    # Try to run Cython, to make sure it works:
    execute_process(
        COMMAND ${CYTHON_BIN} ${CYTHON_FLAGS} ${CMAKE_CURRENT_BINARY_DIR}/cmake/cython_test.pyx
        RESULT_VARIABLE CYTHON_RESULT
	OUTPUT_FILE cython_test.out
	ERROR_FILE cython_test.err
        )
...
ELSE (Cython_FOUND)
	IF (Cython_FIND_REQUIRED)
        if(Cython_Compilation_Failed)
			...
			IF(NOT MSVC)
				MESSAGE(FATAL_ERROR "Your Cython version is too old. Please upgrade Cython to a newer version.")
			ENDIF(NOT MSVC)
