 ...
 */
class MsqMOAB : virtual public MBMesquite::Mesh
{
public:
//********* Functions that are NOT inherited ************
   ...
   *                  is to be improved.
   */
  void set_active_set( moab::EntityHandle meshset,
                       moab::EntityType element_dimension,
                       MsqError& err );
...
//*************** Tags  ***********
    ...
    virtual TagHandle tag_get( const std::string& name,
       ...
       * \param handle     moab::Tag to get properties of.
    ...
    virtual void tag_properties( TagHandle handle,
       ...
       * \param tag_data   moab::Tag data for each element, contiguous in memory.
  ...
  protected:
    ...
    moab::DataType check_valid_flag_tag( moab::Tag tag,
    ...
    void set_int_tag( void* tag, void* meshset, int value, MsqError& err );
       ...
       */
    void get_adjacent_entities( const moab::EntityHandle* source,
                                size_t num_source,
    ...
    /** The IMesh instance */
    moab::Core* meshInstance;

  private:

    void init_active_mesh( moab::Core* mesh,
                           MsqError& err,
        		   const moab::Tag* fixed_tag,
        		   const moab::Tag* slaved_tag );

    void get_flag_data( moab::Tag tag,
                        bool have_tag,
                        moab::DataType type,
    ...
    //moab::EntityHandle elementSet;
    /** ITAPS entity set handle for nodes to move */
    //moab::EntityHandle nodeSet;
     ...
     */
    //std::vector<moab::EntityHandle> inputElements;
